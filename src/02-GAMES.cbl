       ...
       01  CT-CONSTANTS.
           ...
           05  CT-CANVAS-WIDTH  PIC 9(03)    VALUE 50.
           05  CT-CANVAS-HEIGHT PIC 9(03)    VALUE 10.
           05  CT-CHANCE-OF-INITIAL-CELL
                                PIC 9V999    VALUE 0,333.
           05  CT-LIVING-CELL   PIC X        VALUE '@'.             
           05  CT-EMPTY-CELL    PIC X        VALUE '.'.

       01  WS-VECTOR            OCCURS 80 TIMES.
           05  WS-LINE          PIC X(80)    VALUE SPACES.
           05  WS-ARRAY         OCCURS 80 TIMES.
       ...
       01  MAIN-MENU.
           ...
           05  SC-COMMAND      PIC X        TO WS-COMMAND 
               BLINK                        LINE 30 COL 51.
           05  VALUE '         PRESS ENTER TO START                    '
                                            LINE 3 COL 1.
           05  VALUE '         WRITE X TO EXIT THE PROGRAM DIRECTLY    '
                                            LINE 5 COL 1.
       ...
       01  GRID-SCREEN.
           05  SC-LINE         PIC X(80)    LINE WS-X COL 1
                               VALUE SPACES.
           05  SC-BLANK        PIC X(80)    LINE + WS-X COL 1
               BLANK LINE      VALUE SPACES.
           05  SC-MESSAGE      PIC X(50)    LINE 30 COL 1.
           05  SC-COMMAND      PIC X        TO WS-COMMAND 
               BLINK                        LINE 30 COL 51.
      ...
      *     UNTIL WS-COMMAND = 'X'.
       ...
       1000-INIT.
           ...
           MOVE '1000-INIT' TO SC-MESSAGE.
           MOVE WS-X        TO SC-MESSAGE(40:10).
      ...
      *    DISPLAY WS-LINE(WS-X) LINE WS-X.
           MOVE WS-X        TO SC-MESSAGE(40:10)
